    ...
    return (
        <div className=''>
            <div className='preFooter1'>
                <div>
                    {repeatIcon}
                    <span><b>Hassel-free replacement</b> <br /> 10 days replacement policy on mi.com</span>
                </div>
                <div>
                    <span>{shieldIcon}</span>
                    <span><b>100% secure payments</b> <br /> we support Card, Wallet, EMI, COD</span>
                </div>
                <div>
                    {mapIcon}
                    <span><b>Vast Service network</b> <br /> 1000 MI sercice center over 600 cities</span>
                </div>
            </div>
            <div className='preFooter2'>
                ...
                <div>
                    <div><input type="search" placeholder='Enter your E-mail      ' /><button> &gt; </button></div>
                    <span>thanks. you're on our e-mail list for special offers</span>
                </div>
                <div><h4>follow MI</h4>
                ...
                <div className='footer' >
                    ...
                    <div>
                        <p>chat with our virtual AI bot <br />
                            (24/7) live support agent.
                        </p>
                        <div><button className="button">CHAT NOW</button></div>
                    </div>
                </div>
             <div className="end"></div>
             <div className="copy">
             copyright &copy; 2010 - 2024 Xiaomi. All Rights Reserved
             </div>
            </div>
        </div>
